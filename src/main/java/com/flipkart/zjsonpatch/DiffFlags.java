...
public enum DiffFlags {
    ...
    /**
     * This flag instructs the diff generator to generate {@link Operation#REMOVE} operations
     * when removing the remaining elements by traversing from the end of the array rather than
     * producing remove operations from after the last needed element. While the final patch
     * will result in the same output when applied, it gives a more complete result and could
     * be usable elsewhere.
     *
     * @since 0.4.12
     */

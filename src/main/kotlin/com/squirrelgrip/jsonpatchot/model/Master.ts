...
//}
interface Options {
    val acceptedWinsOnEqualPath: Boolean = true
}
...
//    isAdd: Boolean,
//): List<Operation> {
//    val path = if (acceptedOperation is FromOperation) acceptedOperation.from else acceptedOperation.path
//    val lastSlash: Int = path.lastIndexOf('/')
//    if (lastSlash >= 0) {
//        val index = path.substring(lastSlash + 1)
//        val arrayPath = path.substring(0, lastSlash + 1)
//        if (isValidIndex(index)) {
//            proposedOperations.map {
//                it.updatePaths(arrayPath, index, isAdd)
//            }
//        }
//    }
//}
...
// ) {
//     val acceptedWinsOnEqualPath = options.acceptedWinsOnEqualPath
//     var currentIndex = 0
//     var proposedOp: Operation
//
//     // remove operation objects within replaced JSON node
//     proposedOps.flatMap {
//         var acceptedPath = if (acceptedOp is FromOperation) acceptedOp.from else acceptedOp.path
//         val matchesFromToPath = if (proposedOp is FromOperation) {
//             proposedOp.from == acceptedPath || proposedOp.from.indexOf("$acceptedPath/") == 0;
//         } else {
//             false
//         }
//         val matchesPathToPath = (acceptedWinsOnEqualPath && acceptedPath == proposedOp.path) || proposedOp.path.indexOf("$acceptedPath}/") == 0;
...
//}
//
// fun isValidIndex(str: String): Boolean {
//     val n = str.toInt(10);
